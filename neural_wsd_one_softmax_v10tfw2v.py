...
if __name__ == "__main__":
    ...
    parser.add_argument('-embeddings_load_script', dest='embeddings_load_script', required=True, default="None",
    ...
    # word_embeddings_model = Word2Vec.load_word2vec_format(embeddings_model_path, binary=True)
    # src2id = {}
    # word_embeddings = word_embeddings_model.wv.syn0
    # id2src = word_embeddings_model.wv.index2word
    ...
    if test_data == "None":
        ...
        val_data, _, _, _ = data_ops_one_softmax.read_folder_semcor(test_data, lemma2synsets, lemma2id, synset2id, "test")
    val_inputs, val_seq_lengths, val_labels, val_words_to_disambiguate, val_indices, val_lemmas_to_disambiguate = \
        data_ops_one_softmax.format_data(val_data, src2id, lemma2synsets, synset2id, seq_width, word_embedding_case)
    ...
    def new_batch (offset):
        ...
        inputs, seq_lengths, labels, words_to_disambiguate, indices, lemmas = \
            data_ops_one_softmax.format_data(batch, src2id, lemma2synsets, synset2id, seq_width, word_embedding_case)
