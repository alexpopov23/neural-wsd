...
if __name__ == "__main__":
    ...
    sense_embeddings = args.sense_embeddings_src_path
    ...
    data, lemma2synsets, lemma2id, synset2id, id2synset = data_ops_final.read_folder_semcor(data, f_lex=lexicon, lexicon_mode="attested senses")
    #random.shuffle(data)
    partition = int(len(data) * 0.90)
    ...
    if test_data == "None":
        ...
        val_data, lemma2synsets, lemma2id, synset2id, id2synset = \
            data_ops_final.read_folder_semcor(test_data, lemma2synsets, lemma2id, synset2id, mode="test", lexicon_mode="attested senses")
    val_inputs, val_seq_lengths, val_labels, val_words_to_disambiguate, \
    val_indices, val_lemmas_to_disambiguate, similarities = data_ops_final.format_data\
    ...
    def new_batch (offset):
        ...
        inputs, seq_lengths, labels, words_to_disambiguate, indices, lemmas, _ = \
            data_ops_final.format_data(batch, src2id, lemma2synsets, synset2id, id2synset, seq_width,
